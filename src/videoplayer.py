...
class CustomSlider(QSlider):
    def __init__(self, *args, **kwargs):
        ...
        img_width = self.indicator_image.width()
        img_height = self.indicator_image.height()  # Load your image here
        #self.indicator_image = self.indicator_image.scaled(200, 200, aspectRatioMode=Qt.AspectRatioMode.KeepAspectRatio, transformMode=Qt.TransformationMode.SmoothTransformation)
...
class VideoPlayer(QWidget):
    def __init__(self):
        ...
        #self.video_widget.setAlignment(Qt.AlignmentFlag.AlignHCenter)
        ...
        #self.frame_stitch.setAspectRatioMode(Qt.AspectRatioMode.KeepAspectRatio)
        ...
        self.video_path = "C:/Users/legop/Downloads/test_video.mp4"
    ...
    def analyze_video(self, filename):
        ...
        # print(f"FPS: {self.fps}, Total Frames: {self.total_frames}, Duration: {duration}ms")
    ...
    def set_interesting_points(self, frames):
        ...
        # determine interesting points based on video content analysis or user input.
        # For now, we'll set markers at 25%, 50%, and 75% of the video duration.
        # self.results = "./src/results/2024-08-06 11-58-38"
        # self.bbox_dir = os.path.join(self.results, "bounding_boxes")
        # self.indicators = {int((1000/30) * int(frame.split("frame")[1].strip(".jpg"))):frame for frame in os.listdir(self.bbox_dir)}

        # print(f"Indicators set at: {[self.format_time(t) for t in list(self.indicators.keys())]}")
